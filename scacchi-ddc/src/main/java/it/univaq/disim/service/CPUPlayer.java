...
public class CPUPlayer extends Player {
	...
	/**
	 * Seleziona un pezzo casuale del colore del giocatore del turno corrente, e
	 * applica una mossa casuale dall'elenco di mosse disponibili
	 */
	@Override
	public void makeMove(Board board, Game game) {
		...
		for (Piece piece : pieces) {
			...
			// Se ci sono mosse disponibili per questo pezzo, scegliene una a caso e
			// applicala
